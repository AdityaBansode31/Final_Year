...
$roompic=md5($pgpic).$extension;
    ...
    if ($query) {
        ...
        foreach($facilities as $f){
            ...
            $query = "INSERT INTO `tblpgfacilities` (`id`, `pg_id`, `name`, `price`, `status`) VALUES (NULL, '$pg_id', '$f', '$price', '$status');";
              ...
              <option value="<?php echo $row['StateName'];?>"><?php echo $row['StateName'];?></option>
                  <?php } ?> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <label class="checkbox-inline">
                                <input type="radio" id="adf_<?=$facility?>" name="adf_<?=$facility?>" value="Yes" required="true"> Yes
                            </label>
                            <label class="checkbox-inline">
                                <input type="radio" id="adf_<?=$facility?>" name="adf_<?=$facility?>" value="No"> No
                            </label>

                            <label class="input-inline">
                                <input type="number" id="adf_<?=$facility?>_price" name="adf_<?=$facility?>_price" value="0">
                            </label>
